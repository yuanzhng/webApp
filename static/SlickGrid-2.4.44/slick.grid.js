...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function getStateAbbColumns() {
		var newColumns = [];
		var oldColumns = getColumns();
		for(var i = 0; i<oldColumns.length; i++){
			if (oldColumns[i].name.includes("state") && oldColumns[i].name.includes("ab")){
    ...
    */
    ...
    $.extend(this, {
	  ...
	  "getStateAbbColumns": getStateAbbColumns,
